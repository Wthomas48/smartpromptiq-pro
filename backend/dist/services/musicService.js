...
exports.TEMPO_BPM = exports.GENRE_PROMPTS = void 0;
exports.generateMusicWithCloudStorage = generateMusicWithCloudStorage;
exports.buildMusicPrompt = buildMusicPrompt;
exports.generateTrackTitle = generateTrackTitle;
 ...
 */
async function downloadAudioAsBuffer(url) {
 ...
 */
async function generateWithSunoAPI(params) {
    if (!SUNO_API_KEY) {
 ...
 */
async function generateWithAIMusicAPI(params) {
    if (!AI_MUSIC_API_KEY) {
 ...
 */
function generateDemoMusic(params) {
 ...
 */
async function generateMusicWithCloudStorage(params) {
    ...
    if (SUNO_API_KEY) {
        ...
        const uploadResult = await (0, supabase_1.uploadToBucketAndGetSignedUrl)(demoResult.audioBuffer, `demo-${Date.now()}.mp3`, supabase_1.MUSIC_OUTPUT_BUCKET, 'audio/mpeg');
    ...
    const uploadResult = await (0, supabase_1.uploadToBucketAndGetSignedUrl)(audioBuffer, fileName, supabase_1.MUSIC_OUTPUT_BUCKET, 'audio/mpeg');
    if (!uploadResult.success) {
