...
router.post('/seed-courses', async (req, res) => {
    try {
        ...
        const courses = [
            ...
            // AI Agents Masterclass (FREE)
            { title: 'AI Agents Masterclass', slug: 'ai-agents-masterclass', description: 'Complete guide to building, deploying, and monetizing AI chat agents with SmartPromptIQ.', category: 'ai-agents', difficulty: 'intermediate', duration: 30, accessTier: 'free', priceUSD: 0, isPublished: true, order: 58, instructor: 'SmartPromptIQ Team', tags: 'ai-agents,chatbots,free,masterclass', averageRating: 4.9, reviewCount: 876, enrollmentCount: 3210 },
        ];
