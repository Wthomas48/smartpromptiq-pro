...
exports.COST_CONTROL_FLAGS = exports.COST_ALERTS = exports.USAGE_LIMITS = exports.SUBSCRIPTION_TOKENS = exports.TOKEN_PACKAGES = exports.PROFIT_MARGINS = exports.TOKEN_COSTS = exports.API_COSTS = void 0;
exports.calculateAPICost = calculateAPICost;
exports.getTokenCost = getTokenCost;
exports.hasEnoughTokens = hasEnoughTokens;
...
exports.estimateMonthlyAPICost = estimateMonthlyAPICost;
 ...
 */
function calculateAPICost(provider, model, usage) {
    const providerCosts = exports.API_COSTS[provider];
    if (!providerCosts)
        return 0;
 ...
 */
function getTokenCost(category, feature) {
    const categoryCosts = exports.TOKEN_COSTS[category];
    if (!categoryCosts)
 ...
 */
function hasEnoughTokens(userTokens, category, feature) {
 ...
 */
function calculateProfitMargin(apiCost, tokensCharged, tokenValue = 0.035) {
    const revenue = tokensCharged * tokenValue;
    if (apiCost === 0)
        return 100; // 100% margin if no API cost
    return ((revenue - apiCost) / apiCost) * 100;
}
/**
 * Check if within usage limits
 */
function checkUsageLimit(tier, feature, currentUsage, period) {
    const limits = exports.USAGE_LIMITS[tier]?.[period];
    if (!limits)
 ...
 */
function estimateMonthlyAPICost(usagePattern) {
    let total = 0;
    ...
    total += usagePattern.voiceMinutes * 500 * exports.API_COSTS.elevenlabs.standard;
    // Music (assuming mix of types)
    total += usagePattern.musicTracks * 0.04; // Average cost
    // Images (assuming SDXL)
    total += usagePattern.images * exports.API_COSTS.stability['sdxl-1.0'];
    return total;
}
/**
...
exports.default = {
    API_COSTS: exports.API_COSTS,
    TOKEN_COSTS: exports.TOKEN_COSTS,
    PROFIT_MARGINS: exports.PROFIT_MARGINS,
    TOKEN_PACKAGES: exports.TOKEN_PACKAGES,
    SUBSCRIPTION_TOKENS: exports.SUBSCRIPTION_TOKENS,
    USAGE_LIMITS: exports.USAGE_LIMITS,
    COST_ALERTS: exports.COST_ALERTS,
    COST_CONTROL_FLAGS: exports.COST_CONTROL_FLAGS,
    calculateAPICost,
    getTokenCost,
    hasEnoughTokens,
