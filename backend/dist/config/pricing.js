...
exports.validatePricingConfiguration = exports.isValidPriceId = exports.getGenerationLimits = exports.getSubscriptionTier = exports.getPlanFromPriceId = exports.getAddOnPackages = exports.getTokenPackages = exports.getPricingTiers = exports.getStripePriceIds = void 0;
...
exports.getStripePriceIds = getStripePriceIds;
// Pricing tiers configuration
const getPricingTiers = () => {
    const priceIds = (0, exports.getStripePriceIds)();
    return [
        // ─────────────────────────────────────────────────────────────────────────────
...
exports.getAddOnPackages = getAddOnPackages;
...
const getSubscriptionTier = (plan) => {
    const tierMapping = {
        'STARTER': 'starter',
...
const getGenerationLimits = (plan) => {
    const limitsMapping = {
        'STARTER': {
            prompts: 50,
            voice: 50,
...
exports.getGenerationLimits = getGenerationLimits;
...
const validatePricingConfiguration = () => {
    ...
    for (const { name, value } of requiredPriceIds) {
        if (!value || !(0, exports.isValidPriceId)(value)) {
...
exports.validatePricingConfiguration = validatePricingConfiguration;
exports.default = {
    getPricingTiers: exports.getPricingTiers,
    getTokenPackages: exports.getTokenPackages,
    getAddOnPackages: exports.getAddOnPackages,
    getStripePriceIds: exports.getStripePriceIds,
    getPlanFromPriceId: exports.getPlanFromPriceId,
    getSubscriptionTier: exports.getSubscriptionTier,
    getGenerationLimits: exports.getGenerationLimits,
    isValidPriceId: exports.isValidPriceId,
    validatePricingConfiguration: exports.validatePricingConfiguration
};
