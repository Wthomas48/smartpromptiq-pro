...
router.put('/users/:id/tier', authenticate, requireAdmin, [
  body('tier').isIn(['free', 'starter', 'academy_plus', 'pro', 'team_pro', 'enterprise']).withMessage('Invalid tier'),
 ...
 */
router.get('/ai-tools-stats', authenticate, requireAdmin, async (req, res) => {
  try {
