...
const { addDemoToQueue, getQueueStatus, cleanQueue } = require('../services/queueService');

const router = express.Router();

// Generate demo content with queue-based AI processing
...
// Clean queue endpoint (admin only)
